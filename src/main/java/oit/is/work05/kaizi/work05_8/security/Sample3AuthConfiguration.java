package oit.is.work05.kaizi.work05_8.security;
...
public class Sample3AuthConfiguration {
  ...
  public InMemoryUserDetailsManager userDetailsService() {
    ...
    UserDetails user2 = users
        ...
        .roles("CUSTOMER")
        .build();
    UserDetails abo = users
        .username("abo")
        .password("$2y$10$hi0YNeSgA9EZFUS8XcNwUOjqA7yJIDmD.y9wage.Eg98S0eD10h/y")
        .roles("CUSTOMER")
        .build();
    UserDetails admin = users
        ...
        .roles("ADMIN")
        .build();
    UserDetails ado = users
        .username("ado")
        .password("$2y$10$m/19CmgMfa6DMcuIn8GmsOg8pNO0D3n6oujbDIYRX9nMXpVbl5OG2")
        .roles("SELLER")
        .build();
    // 生成したユーザをImMemoryUserDetailsManagerに渡す（いくつでも良い）
    return new InMemoryUserDetailsManager(user1, user2, abo, admin, ado);
  }
